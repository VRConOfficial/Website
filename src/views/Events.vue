								...
								<v-row class="mb-1" no-gutters>
									...
									<v-col cols="8">
										...
										>
											<v-window v-model="onboarding">
												<v-window-item
													v-for="(day, index) in uniqueTimestamps"
													:key="index"
												>
									...
									<v-col cols="2">
										<v-btn
											...
											color="primary"
											class="darkened"
											v-if="onboarding + 1 != uniqueTimestamps.length"
										>
...
export default {
	...
	methods: {
		...
		next() {
			this.onboarding =
				this.onboarding + 1 === this.uniqueTimestamps.length
					? this.onboarding
					: this.onboarding + 1;
		},
		prev() {
